...
from getImageSize import get_image_size as getImageSize
from getImageSize import UnknownImageFormat
from plateReader import plateReader
import ast
from os.path import splitext
from datis_common.arabic_reshaper import put_text_on_image
from datis_common.jalali import jalali
from violationSending import violationSending
...
class violationProcessing():
    def __init__(self,
        ...
        try:
            ...
            logging.info(f'Problem in connecting to plate reader: {e}')
            # return None
